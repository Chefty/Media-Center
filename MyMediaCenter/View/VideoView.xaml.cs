...
namespace MyMediaCenter.View
{
    ...
    public class Item2
    {
        ...
        public Item2(string name, DateTime date, int size)
        {
            this.Name = name;
            this.Date = date;
            this.Size = size;
    ...
    public partial class VideoView : System.Windows.Controls.UserControl
    {
        ...
        private async void AnimActionsGrid()
        {
            ...
            ImportVideo.BeginAnimation(OpacityProperty, Opacity);
        ...
        private void LoadPathFolder()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM videofolders";
        ...
        private Boolean isCorrupt(string item)
        {
            ...
            {
                System.Windows.MessageBox.Show("Video corrupted found");
                return false;
            }
        }
        private void AddFolderToDataBase(String pathFolder, String nameFolder)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO videofolders (id, name, path) VALUES (NULL, @namefolder, @pathfolder)";
        ...
        private void DeleteFolder(String nameFolder)
        {
            ...
            {
                cmd = con.CreateCommand();
                cmd.CommandText = "DELETE FROM videofolders WHERE name = @namefolder";
                cmd.Parameters.AddWithValue("@namefolder", nameFolder);
                cmd.ExecuteNonQuery();
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                video_duration.Minimum = 0;
                video_duration.Maximum = media.NaturalDuration.TimeSpan.TotalSeconds;
                video_duration.Value = media.Position.TotalSeconds;
            }
        }
        ...
        private void sliProgress_DragCompleted(object sender, DragCompletedEventArgs e)
        {
            ...
            media.Position = TimeSpan.FromSeconds(video_duration.Value);
        }
        ...
        {
            video_text_start.Text = TimeSpan.FromSeconds(video_duration.Value).ToString(@"hh\:mm\:ss");
            video_text_end.Text = TimeSpan.FromSeconds((media.NaturalDuration.TimeSpan.TotalSeconds - video_duration.Value)).ToString(@"hh\:mm\:ss");
        }
